...
current_subwindow: KI-W7-I004
current_assignment_id: ASG-KI-W7-I004-01
assigned_agent: KI-W7-WINDOW-AGENT
subwindow_type: INTEGRATION_REASSESSMENT
authorized_write_file: NONE
authorized_read_scope: [A1-A8, KI-W7 S1-S3, all fourteen final W7 paths, accepted build and measurement scripts, gitignored dist/lambda outputs]
authorized_actions: [execute CV1 through CV7 in exact order with established measurement immediately after build-lambda, append final evidence and CAS handoff only after all gates pass]
...
next_subwindow: STOP_PARENT_REVIEW
blocker: null
last_updated: 2026-08-24T19:10:00+05:30
```

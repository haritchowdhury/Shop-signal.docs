...
- [x] `C121-P1` Verify assignment, accepted inputs, baseline and scope.
  Evidence: `EV-KI-W6-R58` (A5 state 166; committed baseline `72fe4f99…` at `a234a9e`).
- [x] `C121-T1` Apply item 4 exactly and preserve item 5. Evidence: `EV-KI-W6-R58` (ending digest `8d89bb19…`).
- [x] `C121-V1` Run both local-now checks. Evidence: `EV-KI-W6-R58` (leaf + independent re-run, both exit 0).
- [x] `C121-H1` Return diff/digest/preservation proof; stop for window review.
  Evidence: `EV-KI-W6-R58` (certificate returned; C121 accepted after CV58).
...
- [x] `C122-P1` Verify assignment, baseline and one-file scope.
  Evidence: `EV-KI-W6-R60` (A5 state 167; baseline `cbcd304a…`).
- [x] `C122-T1` Apply item 4 exactly and preserve item 6. Evidence: `EV-KI-W6-R60` (ending digest equals spec pin `d9a76ceb…`).
- [x] `C122-V1` Run both local-now checks and match the ending digest. Evidence: `EV-KI-W6-R60` (leaf + independent re-run, both exit 0).
- [x] `C122-H1` Return diff/digest/preservation proof; stop for window review.
  Evidence: `EV-KI-W6-R60` (certificate returned; C122 accepted).
...
- [x] `C123-P1` Verify accepted C122, C121 baseline and one-file scope.
  Evidence: `EV-KI-W6-R61` (C122 accepted via R60; baseline `8d89bb19…`).
- [x] `C123-T1` Apply item 4 at the exact item-5 boundary. Evidence: `EV-KI-W6-R61` (ending digest equals spec pin `448921c7…`).
- [x] `C123-V1` Run both local-now checks and match the ending digest. Evidence: `EV-KI-W6-R61` (leaf + independent re-run, both exit 0).
- [x] `C123-H1` Return diff/digest/preservation proof; stop for window review.
  Evidence: `EV-KI-W6-R61` (certificate returned; C123 accepted after CV64).
...
- [x] `KI-W6-CV70` Recompute the exact two baselines/endings, two-path digest,
  ...
  and prove no case/control/registry/manifest/certificate member changed. Evidence: `EV-KI-W6-R64`.
